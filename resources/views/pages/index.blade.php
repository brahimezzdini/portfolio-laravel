...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger"style="font-style: italic;color:#fed136;font-family: Droid Serif, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Helvetica Neue, Arial, sans-serif, Apple Color Emoji, Segoe UI Emoji, Segoe UI Symbol, Noto Color Emoji;
            " href="#page-top"> Ezzdini  <img style="height: auto; width:40px;border-radius:50%"src="assets/img/ibra.jpg"   >  Brahim</a>
        ...
        <header class="masthead" style="background-image: url(<?php echo $main->bc_img ?>);">
            <div class="background" style="background: -webkit-gradient(linear, 0% 0%, 100% 0%, from(rgb(231, 67, 55)), to(rgb(32, 27, 64)));"></div>
            <div class="container">
                <div class="masthead-subheading">{{$main->sub_title}}</div>
                <div class="masthead-heading text-uppercase">{{$main->title}}</div>
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="{{url($main->resume)}}">Download CV</a>
            </div>
        </header>
        <!-- Services-->
                            ...
                            <div class="col-lg-4 col-sm-6 mb-4">
                                <div class="portfolio-item">
                                    ...
                                    <div class="portfolio-caption">
                                        <div class="portfolio-caption-heading">{{$portfolio->lien}}</div>
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Mes expériences professionnelles</h2>
                </div>
                <ul class="timeline">
                    @if (count($abouts) > 0)
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-left">Copyright © Ezzdini Brahim 2020</div>
